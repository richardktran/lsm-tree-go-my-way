...
- [x] Improve `MemTable` by using `Skip List` as underlying data structure
- [x] Implement `Compaction` to merge multiple SSTables into one SSTable
- [x] Lookup `Sparse Index` by binary search
